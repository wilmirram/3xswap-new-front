...
export function Footer() {
  ...
  return (
    <footer className="relative bg-base-300 text-xs text-secondary-content px-8 pt-16 pb-40 pl-80 pr-80 overflow-hidden">
      <div className="absolute top-0 left-0 w-full h-full z-0">
        <img
          src="/landing/blue-light.svg"
          alt="blue light"
          className="absolute opacity-40 w-full h-full object-cover scale-[4] top-[-0%] right-[-80%] z-[-30]"
        />
        <img
          src="/landing/background-structures3.jpg"
          alt="background structures"
          className="absolute opacity-60 w-full h-full z-40 scale-[8.0] top-[50px] object-cover"
        />
      </div>
...
function FirstFooterElement() {
  const t = useTranslations();
  return (
    <div className={`relative text-xs flex flex-col pr-10 ${marginBottom}`}>
      <Image
        ...
        height={22}
        className="h-auto"
      //className="!my-0 w-30 mx-0 hidden min-[350px]:block"
      //priority={true}
      />
      <div className="">
